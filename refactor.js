...
const returnReplacement = `                    {activeTab === 'Feed' && (
                        <FeedTab
                            feedData={feedData}
                            feedScope={feedScope}
...
lines.splice(884, 47, ...returnReplacement.split('\\n'));
...
lines.splice(530, 4, ...hookAndCheer.split('\\n'));
...
// 7. add imports
const importsCode = `import FeedTab from '../components/community/FeedTab';
import ChallengesTab from '../components/community/ChallengesTab';
import ClubsTab from '../components/community/ClubsTab';`;
lines.splice(8, 0, ...importsCode.split('\\n'));

fs.writeFileSync(file, lines.join('\\n'), 'utf8');
console.log('Refactoring successfully applied via splicing!');
